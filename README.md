...
| Key | Default | Meaning |
|---|---|---|
| `MODEL` | `openrouter/z-ai/glm-5.3-flash:high` | Executor (OMP) model. Any model id or OMP alias/role. Prewalk is disabled for the executor — the plan already exists. |
